...
// clearfix
function show_clearfix($atts, $content = null) {
	return '<div class="clearfix">'.do_shortcode($content).'</div>';
}
add_shortcode('clearfix', 'show_clearfix');

// container
function show_container($atts, $content = null) {
	return '<div id="container" class="clearfix"> <div id="content" class="full-width">'.do_shortcode($content).'</div></div>';
}
add_shortcode('container', 'show_container');
