...
class Appointment_Widget extends WP_Widget {
  	...
  	function Appointment_Widget() {	
  		...
  		$this->WP_Widget( 'Appointment_Widget', 'HealthPress : Appointment Widget', $widget_ops);
  	}
		...
		$target_email = $instance['target_email'];
  		...
  		echo $before_widget;
            ...
            <div class="appointment">
                    ...
                    <form action="<?php echo site_url(); ?>/wp-admin/admin-ajax.php" id="appoint-form" method="post">
                            <p>
							...
							<p>															
                                ...
                                <input type="hidden" name="target" value="<?php echo $target_email; ?>" />
