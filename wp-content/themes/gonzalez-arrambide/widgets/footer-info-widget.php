...
class Footer_Information_Widget extends WP_Widget {
  	...
  	function Footer_Information_Widget() 
	{	
  		...
  		$this->WP_Widget( 'Footer_Information_Widget', 'HealthPress : Footer Information Widget', $widget_ops);
  	}
	...
	{  
        ...
        ?>
        <p><?php _e("Note: Please provide footer logo, footer about text and footer read more button link in Theme Options.", 'framework'); ?></p> 		  		  					  		
        <?php
    }
