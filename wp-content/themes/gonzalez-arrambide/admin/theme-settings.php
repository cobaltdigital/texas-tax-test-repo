...
$options[] = array( "help" => __('help','framework'),
			"desc" => __('Provide help number to display it in top navigation.','framework'),
			"id" => $shortname."_help_link",
			"std" => "",
			"type" => "text");
...
$options[] = array( "name" => __('Slogan Tax','framework'),
			"desc" => __("Main slogan tax.",'framework'),
			"id" => $shortname."_slogan_tax",
			"std" => __("We are proud of our organization.", "framework"),
			"type" => "text");
			
$options[] = array( "name" => __('Button','framework'),
			"desc" => __("Main button.",'framework'),
...
$options[] = array( "name" => __('Title','framework'),
    "desc" => __("",'framework'),
    "id" => $shortname."_first_headinga",
